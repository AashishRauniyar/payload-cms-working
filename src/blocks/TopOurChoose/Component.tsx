        ...
        <div className="flex-shrink-0 flex items-center justify-center p-6">
          <div className="relative group">
            {productImage ? (
              ...
              <div className="w-49 h-61 flex items-center justify-center transition-transform duration-300 group-hover:scale-105">
                <div className="w-41 h-53 bg-white rounded border border-gray-300 flex items-center justify-center shadow-sm">
