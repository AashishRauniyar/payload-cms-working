  ...
  const content = (
    <div className="max-w-6xl mx-auto bg-white shadow-lg">
      ...
      <div className="flex">
        ...
        {/* Center Image */}
        <div className="flex-shrink-0 flex flex-col items-center justify-center px-8 py-6">
          {/* Product Image */}
          <div className="relative group mb-8">
            {productImage ? (
              ...
              <div className="w-64 h-80 flex items-center justify-center transition-transform duration-300 group-hover:scale-105">
                <div className="w-52 h-64 bg-white flex items-center justify-center">
          ...
          {/* Buttons positioned below image with proper spacing */}
            ...
            {buttons && buttons.length > 0 ? (
              buttons.map((button, index) => (
                <CMSLink
                  ...
                  className={`group relative overflow-hidden font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center ${
              ...
              <>
                <button className="group relative overflow-hidden bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl shadow-blue-200">
                ...
                <button className="group relative overflow-hidden bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl shadow-green-200">
