    ...
    <div className="pros-cons-container w-full max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
      ...
      <div className="pros-cons-grid grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-16">
        ...
        <div className="relative order-1 lg:order-1">
          ...
          <div className="pros-cons-card bg-white  border-green-400 rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 pt-12 sm:pt-14 lg:pt-16 relative shadow-sm hover:shadow-md transition-shadow duration-300">
        ...
        <div className="relative order-2 lg:order-2">
          {/* Card Container - Responsive Padding */}
          <div className="pros-cons-card bg-white  border-red-400 rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 pt-12 sm:pt-14 lg:pt-16 relative shadow-sm hover:shadow-md transition-shadow duration-300">
            {/* Header Circle - Responsive Sizing */}
            <div className="pros-cons-header-circle absolute -top-8 sm:-top-10 lg:-top-12 left-1/2 transform -translate-x-1/2">
